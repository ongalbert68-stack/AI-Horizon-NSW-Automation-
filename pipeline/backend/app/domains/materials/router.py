...
from app.domains.materials import crud
from app.domains.materials.schema import (
    FluidMaterialCreate,
    FluidMaterialRead,
    FluidMaterialUpdate,
)
...
@router.get(
    "", response_model=Page[FluidMaterialRead], summary="List fluid materials",
...
@router.post(
    "", response_model=FluidMaterialRead, status_code=status.HTTP_201_CREATED,
...
@router.get("/{material_id}", response_model=FluidMaterialRead, summary="Get a fluid material")
...
@router.patch("/{material_id}", response_model=FluidMaterialRead, summary="Update a fluid material")
def update_material(
...
@router.delete("/{material_id}", status_code=status.HTTP_204_NO_CONTENT, summary="Delete a fluid material")
