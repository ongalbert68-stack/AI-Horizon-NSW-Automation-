"""Enum vocabulary shared across ERD domains — kept out of any one domain
folder since DispenseStation, FluidMaterial, Case, and CheckResult each use
a different subset of these."""

import enum


class DispenserClass(str, enum.Enum):
    """Half the 2b hard filter."""
...
class RankTier(str, enum.Enum):
    """Step 5's confidence tier — T1..T4, see ranking/tier.py."""
