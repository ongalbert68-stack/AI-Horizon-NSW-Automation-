...
from app.crud import dispense_station as crud
from app.schemas.common import Page
from app.schemas.dispense_station import (
...
@router.post(
    "",
    response_model=DispenseStationRead,
...
@router.get(
    "/{station_id}",
    response_model=DispenseStationRead,
    summary="Get a dispense station",
)
...
@router.patch(
    "/{station_id}",
    response_model=DispenseStationRead,
    summary="Update a dispense station",
)
def update_station(
...
@router.delete(
    ...
    summary="Delete a dispense station",
)
