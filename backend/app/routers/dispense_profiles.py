...
from app.crud import dispense_profile as crud
from app.schemas.common import Page
from app.schemas.dispense_profile import (
...
@router.get(
    "",
    response_model=Page[DispenseProfileReadWithMaterial],
    summary="List dispense profiles",
...
@router.post(
    "",
    response_model=DispenseProfileReadWithMaterial,
...
@router.get(
    "/{profile_id}",
    response_model=DispenseProfileReadWithMaterial,
    summary="Get a dispense profile",
)
...
@router.patch(
    "/{profile_id}",
    response_model=DispenseProfileReadWithMaterial,
    summary="Update a dispense profile",
)
def update_profile(
...
@router.delete(
    ...
    summary="Delete a dispense profile",
)
